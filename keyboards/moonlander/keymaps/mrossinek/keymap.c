...
[UNIC] = LAYOUT_moonlander(
     ...
     _______, X(SLEEP), X(SHRUG), X(CONFUSED), X(THINK)  , _______,                                                               _______ , _______    , _______  , _______    , _______    , _______,
     _______, _______ , _______ , _______    , _______   ,           _______         ,                        _______          ,            _______    , X(MUSCLE), X(THUMBSDN), X(THUMBSUP), _______,
                                                                     _______, _______, _______,      _______, _______, _______
),
